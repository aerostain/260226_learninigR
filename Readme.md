...
1. Análisis univariado de datos. Debo resumir las estadísticas principales de cualquier vector de datos continuos o no.
    * Generar un función que pueda calcular las estádisticas necesarias.
    * Usarla con dplyr de forma profesional (ungroup y lo demás etc.) usando librería broom.
    * Intervalos de confianza y pruebas de hipotesis para continuas, ordinales y proporciones.
    * Gráficar con ggplot.
